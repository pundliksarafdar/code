...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#submit").click(function(){
			...
			if(flag==true){
				$("#studentchoosesubjectforward").submit();
			}	   
		});
...
<hr>
<form action='studentchoosesubjectforward?successforward=<c:out value="${requestScope.successforward}"></c:out>' id="studentchoosesubjectforward" method="post">
	<div class="container">
		<div class="form-group">
			...
			<div class="col-sm-5" align="left">
				...
				%>
				<select id="classnameselect" class="form-control" name="classname">
