...
<script type="text/javascript" src="js/view/editCustomUserSubjectiveQuestion.js"></script>
<script>
	...
	var getQuestionUrl = "/rest/customuserservice/paraquestion/"+queId+"/"+subId+"/"+divId;
	var handler = {};
...
<div id="subjectiveDiv" class="container">
	<form action="addquestion" method="post" enctype="multipart/form-data" id="addSubjectiveQuestion" class="form-horizontal corex-form-container">
 	...
 	<form action="customeUserSearchQuestion" method="post" id="searchQuestion">
