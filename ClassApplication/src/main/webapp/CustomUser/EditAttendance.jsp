...
<jsp:include page="attendanceHeader.jsp" >
		<jsp:param value="active" name="customeUserEditAttendance"/>
	</jsp:include>
	<div class="well">
		<div class="row">
			<div class="col-md-3">
	...
	<div class="col-md-4">
	Update whole day attendance
	</div>
	<div class="col-md-2">
	<button class="btn btn-primary btn-sm comonMarkAttendance">Update Attendance</button>
	</div>
	</div>
	</div>
	<div class="container" id="attendanceScheduleDiv" style="padding: 1%;">
