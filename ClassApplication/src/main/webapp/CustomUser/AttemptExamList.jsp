...
$(document).ready(function(){
	...
	$(".searchExams").click(function(){
		...
		rest.get("rest/customuserservice/getOnlineExamList/"+division+"/"+batch,handlers);
		}
	});
	...
	$("#examTable").on("click",".attemptExamList",function(){
		...
		handlers.error = function(e){console.log("Error",e)}
		rest.get("rest/customuserservice/getOnlineExamSubjectList/"+division+"/"+batch+"/"+$(this).prop("id"),handlers);
	});
	...
	$("#examSubjectTable").on("click",".attemptExamStart",function(e){
		...
		if(e){
			...
			var win = window.open("customeUserAttemptExam?"+formData,"",params)
...
<jsp:include page="ExamHeader.jsp" >
		<jsp:param value="active" name="customeUserOnlineExamList"/>
	</jsp:include>
<div class="well">
<div class="row">
<div class="col-md-3">
