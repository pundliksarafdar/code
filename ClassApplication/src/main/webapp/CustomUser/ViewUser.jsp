...
$(".edit").click(function(){
	...
	var handlers = {};
		...
		rest.get("rest/customuserservice/getinstuser/"+$(this).prop("id"),handlers);
});
...
$("#submit").click(function(){
	...
	rest.put("rest/customuserservice/updateUser/"+joiningDate+"/"+education,handlers,JSON.stringify(register));
	}
});
...
<jsp:include page="RoleHeaders.jsp" >
		<jsp:param value="active" name="customeUserViewUser"/>
</jsp:include>
...
<tbody>
	...
	<tr>
		...
		<td>
			...
			<% if(ArrayUtils.contains(child_mod_access,"55")){ %>
