...
$(document).ready(function(){
	...
	$("#subject").change(function(){
		...
		if ($(this).find('option:selected').prop("class") == "singleSub"){
			...
			handlers.error = function(){};
			rest.get("rest/customuserservice/getCombineSubjects/"+this.value,handlers);
		}
		}else{
			$(".createExamSelectQuestionTopic").empty();
			$(".createExamSelectQuestionTopic").append("<option value='-1'>Select Topic</option>");
...
var generatePattern = function(){
	...
	rest.post("rest/customuserservice/addQuestionPaperPattern",handlers,QuestionPaperPatternJson,false);
...
<body>
	<jsp:include page="ExamHeader.jsp" >
		<jsp:param value="active" name="customeUserCreateExamPatten"/>
	</jsp:include>
