 ...
 <s:if test="hasActionErrors()">
    <div class="alert alert-danger nodecoration">
        <s:actionerror/>
    </div>
</s:if>
<div class="alert alert-success">
	...
	<form action="saveadaction" method="post">
	<div class="row">
	...
	<select id="advertiseOptionCountry" name="advertiseOptionCountry" class="btn btn-default"></select>
	</div>
	
	<div class="col-lg-4 hide">
	<label for="advertiseOptionState">State</label>
	<select id="advertiseOptionState"  name="advertiseOptionState" class="btn btn-default"></select>
	</div>
	
	<div class="col-lg-4 hide">
	<label for="advertiseOptionCity">City</label>
	<select id="advertiseOptionCity" name="advertiseOptionCity" class="btn btn-default"></select>
	</div>
	</div>
	<div class="form-group">
	<label for="htmlEditor">Insert Add Here in HTML</label>
	<div id="htmlEditor">
		<textarea class="form-control" name="textadvertise"></textarea>
	</div>
	</div>
	<div class="form-group">
