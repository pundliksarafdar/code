...
padding-top: 2px;
	...
	$(document).ready(function(){
		...
		$('form[action="addquestion"]').on("click",".removeOption",function(){
		...
		$('form[action="addquestion"]').on("click",".uploadAnswerImage",function(){
		...
		$("input.startuplodingexamSave").on('click',function(){
			...
			if(quesType == "1"){
				...
				if(flag==false){
				$("#subjectiveDiv").find("#division").val($("#classownerUploadexamDivisionName").val());
				$("#subjectiveDiv").find("#subject").val($("#classownerUploadexamSubjectNameSelect").val());
				$("#subjectiveDiv").find("#topicID").val($("#classownerUploadQuestionTopicSelect").val());
				$("#subjectiveDiv").find("#actionname").val("submitquestions");
				$("#subjectiveDiv").find("#questiontype").val($("#classownerQuestionTypeSelect").val());
			...
			if(!inValid){
				...
				if(!invalidOption){
					...
					$("#MCQDiv").find('form[action="addquestion"]').submit();
				}
			}
			}else if(quesType == "3"){
				...
				if(flag==false){
				$("#paragraphDiv").find("#division").val($("#classownerUploadexamDivisionName").val());
				$("#paragraphDiv").find("#subject").val($("#classownerUploadexamSubjectNameSelect").val());
				$("#paragraphDiv").find("#topicID").val($("#classownerUploadQuestionTopicSelect").val());
				$("#paragraphDiv").find("#actionname").val("submitquestions");
				$("#paragraphDiv").find("#questiontype").val($("#classownerQuestionTypeSelect").val());
				$("#paragraphDiv").find('form[action="addquestion"]').submit();
				}
			}
		});
		
		$("#CancleUploading").on("click",function(){
			//$("#addquestion").prop("action","cancleuploading");
		...
		$('form[action="addquestion"]').on("change","input[type='file']",setQuestionSize);
	...
	<form action="addquestion" method="post" enctype="multipart/form-data" id="addquestion" class="form-horizontal corex-form-container">
 			...
 			<div class="col-md-10">
 				<textarea rows="5" cols="100" id="subjectiveQuestion" name="question" class="form-control"></textarea>
 ...
 <form action="addquestion" method="post" enctype="multipart/form-data" id="addquestion" class="form-horizontal corex-form-container">
	...
	<form action="addquestion" method="post" enctype="multipart/form-data" id="addquestion" class="form-horizontal corex-form-container">
 			...
 			<div class="col-md-10">
 				...
 				<textarea rows="5" cols="100" id="paragraphText" name="paragraphText" class="form-control"></textarea>
 			</div>
 			</div>
 			<div class="form-group">
