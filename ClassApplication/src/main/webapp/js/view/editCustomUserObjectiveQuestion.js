var SAVE_OBJECTIVE_EXAM = "#saveObjectiveExam";
	...
	var saveObjectiveExamUrl = "/rest/customuserservice/saveObjective";
...
function loadObjectiveQuestion(data){
	...
	for(var index=0;index<data.primaryImage.length;index++){
		...
		var imgTag = "<img src='/rest/commonservices/customUserimage/"+data.primaryImage[index]+"' width='200px' height='200px' />";
...
function addOptionValue(text,selected,images,currentIndex,checked){
	...
	for(var index=0;index<images.length;index++){
		var imgTag = "<img src='/rest/commonservices/customUserimage/"+images[index]+"' width='200px' height='200px' />";
