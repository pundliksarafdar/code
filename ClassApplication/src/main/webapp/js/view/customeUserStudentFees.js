...
var getAllBatchStudentsFeesUrl = "rest/customuserservice/getAllBatchStudentsFees/";
var saveStudentBatchFee = "rest/customuserservice/saveStudentBatchFeesTransaction/";
var updateStudentFeesAmt = "rest/feesservice/updateStudentFeesAmt/";
var printReceiptUrl = "rest/feesservice/getPrintDetail/";
var sendDueAlertURL ="rest/customuserservice/sendFeesDue";
var feeReceiptUrl = "rest/customuserservice/feeReceipt/";	
/*************/
...
$(document).ready(function(){
	...
	parent_mod_access = $("#parentAccessRights").val().split(",");
...
function loadStudentTableSuccess(data){
	...
	feesDataTable = $(STUDENT_FEES_TABLE).DataTable({
			...
			{
				title: "",bSortable:false,data:null,render:function(){
					var buttons = "";
					if($.inArray( "46", child_mod_access) != "-1"){
						buttons = buttons + "<input type='button' class='btn btn-success btn-xs payFees' value='Save'/>&nbsp;";
						}
					if($.inArray( "47", child_mod_access) != "-1"){
					buttons = buttons + "<input type='button' class='btn btn-primary btn-xs printReceipt' value='Receipts'/>&nbsp;";
					}
						if($.inArray( "13", parent_mod_access) != "-1"){
						buttons = buttons + "<input type='button' class='btn btn-primary btn-xs sendDue' value='Send Due'/>";
						}
					return  buttons;
