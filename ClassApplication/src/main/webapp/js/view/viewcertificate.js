	  ...
	  var button = ui.button({
	    ...
	    click: function () {
	      // invoke insertText method with 'hello' on editor module.
	    	...
	    	data = "<html><link href='/css/bootstrap.min.css' rel='stylesheet'><body class='container'><div class='certificatePanel' style='background-color:"+globalBackgroundColor+";padding:2%'>" +
