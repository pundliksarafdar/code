...
$(document).ready(function(){
	...
	$(SAVE_QUESTION_PAPER).on("click",function(){
		...
		if(desc && desc.trim().length!==0){
			...
			rest.post("rest/customuserservice/saveQuestionPaper/"+patternId+"/"+questionPaperName+"/"+division+"/"+subject+"/"+compSubjectIds,handlers,JSON.stringify(questionPaperData),true);	
		}else{
