	 ...
	 $("#noticeType").change(function(){
		...
		if(!loadFlag){	 
		 var commonHandler = {};
			...
			rest.get("rest/classownerservice/getStaffNotice",commonHandler);	
			loadFlag = true;
		}	 
		}	
		 });
...
function deleteStudentNotice(id,that){
	...
	rest.deleteItem("rest/classownerservice/deleteStudentNotice/"+id,handlers);
}
...
function deleteStaffNotice(id,that){
	...
	rest.deleteItem("rest/classownerservice/deleteStaffNotice/"+id,handlers);
}
</script>
</head>
<body>
<jsp:include page="NoticeBoardHeader.jsp" >
		<jsp:param value="active" name="viewNoticeBoard"/>
	</jsp:include>
<div class="well">
<div class="row">
<div class="col-md-3">
